  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ scale: 0.9, y: 20 }}
        transition={SPRING}
        className="w-full max-w-lg bg-white rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[85vh] relative z-[101]"
      >
        {/* Header */}
        <div className="px-6 pt-5 pb-3 flex justify-between items-center border-b border-neutral-100 bg-white relative z-10">
          <h3 className="text-base font-bold text-neutral-800" style={{ fontFamily: "var(--font-noto-serif)" }}>
            选择您的AI数字人形象
          </h3>
          <button
            onClick={onClose}
            className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-neutral-100 hover:bg-neutral-200 text-neutral-600 transition-colors text-xs font-medium cursor-pointer"
            title="关闭窗口"
          >
            <span>取消</span>

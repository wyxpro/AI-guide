  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-0 md:p-4 select-none font-sans overflow-y-auto">
      ...
      <motion.div 
        ...
        transition={SPRING}
        className="relative z-10 w-full h-full md:h-auto md:max-h-[92vh] max-w-5xl bg-[#090C15]/95 text-[#D1F4FF] rounded-none md:rounded-3xl border-0 md:border border-[#00E5FF]/30 flex flex-col overflow-hidden shadow-[0_0_50px_rgba(0,229,255,0.2)]"
      >
        {/* ── Top Header (Cyberpunk tech style) ── */}
        <header className="sticky top-0 z-30 bg-[#0F1322]/90 backdrop-blur-md border-b border-[#00E5FF]/20 px-4 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              onClick={onClose}
              className="w-9 h-9 ml-2 rounded-xl bg-[#151D35] hover:bg-[#1E294A] border border-[#00E5FF]/30 flex items-center justify-center transition-all text-[#00E5FF] active:scale-95 shadow-[0_0_8px_rgba(0,229,255,0.2)]"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
                    ...
                    >
                      ...
                      {onRecognized && (
                        <motion.button
                          ...
                          className="w-full py-3 rounded-xl text-xs font-black flex items-center justify-center gap-2 text-white shadow-lg shadow-purple-900/25 transition-all active:scale-95 mt-4 bg-gradient-to-r from-[#BD00FF] to-[#FF007F] border border-[#FF007F]/40"
                        >
                          <Sparkles className="w-4 h-4 text-white" />

...
export const NATIONAL_SPOTS: NationalSpot[] = [
  ...
  },
  {
    ...
    category: "cultural",
    city: "成都",
    description: "锦里古街紧邻武侯祠，以明清川西民居为基础，融入了丰富的三物文化。青石板路两旁茶楼林立，商铺高挂红灯笼。这里汇集了三大炮、叶儿粑等四川地道小吃，还有皮影戏、变脸等民间民俗表演，充满烟火气。",
  ...
  },
  {
    ...
    category: "cultural",
    city: "西藏",
    description: "布达拉宫位于西藏自治区拉萨市区西北的红山上，是一座规模宏大的宫堡式建筑群。它最初由吐蕃王朝藏王松赞干布兴建，后经五世达赖喇嘛重建，成为历代达赖喇嘛的冬宫，是西藏政教合一的权力中心，集宗教、艺术、历史于一体的雪域圣殿。",
  ...
  },
  {
    ...
    category: "nature",
    city: "成都",
    description: "九寨沟自然保护区位于四川省阿坝藏族羌族自治州九寨沟县境内，因沟内有树正、荷叶、则查洼等九个藏族村寨而得名。这里以色彩斑斓的翠海、重叠多姿的瀑布、五彩缤纷的彩林、洁白无瑕的雪峰等奇观著称，享有“童话世界”的美誉。",
    imageUrl: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=1000&q=80",
    duration: 360,
    distance: "距成都市区约400公里",
    rating: 49,
    visitCount: 112000,
  ...
  },
  {
    ...
    category: "nature",
    city: "山东",
    description: "泰山座落于山东省中部，古称岱宗，为“五岳之首”、“天下第一山”。泰山不仅是一座自然名山，更是中华民族的历史文化缩影。自秦汉以来，历代帝王在此举行封禅大典，留下了极为丰富的历史文化遗存和摩崖石刻。",
  ...
  },
  {
    ...
    category: "nature",
    city: "安徽",
    description: "黄山位于安徽省南部黄山市境内，以“奇松、怪石、云海、温泉、冬雪”五绝著称于世。徐霞客曾两游黄山，叹曰：“五岳归来不看山，黄山归来不看岳”，代表了黄山在中国名山大川中无可替代的崇高地位。",
  ...
  },
  {
    ...
    category: "history",
    city: "长沙",
    description: "岳麓山位于湖南省长沙市湘江西岸，古木参天，是南岳衡山七十二峰的最后一峰。山中汇集了中国古代四大书院之一的岳麓书院、中国四大名亭之一的爱晚亭、千年古刹麓山寺等众多名胜古迹，是长沙的文脉所在。",
  ...
  },
  {
    ...
    category: "nature",
    city: "长沙",
    description: "橘子洲坐落于长沙市区对开湘江江心，是湘江下游最大的沙洲。橘子洲介名山城市间，凌袅袅蜿蜒江水，这里伫立着巨大的青年毛泽东艺术雕塑，是游客到访长沙必打卡的城市名片。",
    imageUrl: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&q=80",
    duration: 150,
    distance: "长沙市区湘江江心",
    rating: 48,
    visitCount: 88000,
    tags: ["青年毛泽东雕像", "湘江明珠", "城市名片", "江风漫步"],
  ...
  },
  {
    ...
    category: "history",
    city: "武汉",
    description: "黄鹤楼座落于湖北省武汉市蛇山之巅，濒临万里长江，自古享有“天下江山第一楼”和“天下绝景”之称。崔颢在此题诗“昔人已乘黄鹤去，此地空余黄鹤楼”，使其声名大噪，成为中国古典诗词文化的标志性地标。",
  ...
  },
  {
    ...
    category: "nature",
    city: "武汉",
    description: "武汉东湖生态旅游风景区位于武汉市城区东部，是中国第二大城中湖。景区内湖水浩淼，绿树成荫，建有长达百公里的东湖绿道，是市民休闲、骑行、踏青、赏花（梅花、樱花、荷花）的绝佳去处。",
